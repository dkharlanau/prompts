...
| Route commands or inputs | [Entry point](AGENTS.md), [catalog](catalog.yaml), [renderer](scripts/prompts.py) | Keep four command routes and six fields consistent; exercise all render routes |
